...
func TestStylesForConfigEmptyThemeLeavesExistingStylesUnchanged(t *testing.T) {
	...
	assertColor(t, s.HelpText.GetForeground(), def.HelpText.GetForeground(), "help text foreground")
	...
	assertColor(t, s.TabSeparator.GetForeground(), def.TabSeparator.GetForeground(), "tab separator foreground")
